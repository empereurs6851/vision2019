...
class GreenTapeDetect:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [37.0, 90.0]
        self.__hsv_threshold_saturation = [57.0, 255.0]
        self.__hsv_threshold_value = [74.0, 255.0]
        ...
        self.__filter_contours_solidity = [56.65467625899281, 100]
        ...
        self.__filter_lines_min_length = 26.0
        self.__filter_lines_angle = [61.51079136690649, 141.9112627986348]
        ...
        if len(lines) != 0:
            if isinstance(lines[0], numpy.ndarray):
                for i in range(1, len(lines[0])):
                    tmp = GreenTapeDetect.Line(lines[0][i, 0][0], lines[0][i, 0][1],
